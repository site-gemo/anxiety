...
paceOptions = {
  ...
  $('#preloader').delay(0).animate({top: '-120%'}, 5800, $.bez([0.19,1,0.22,1]));
  ...
  observeParents: true,
    ...
    //parallax 
      $(document).ready(function() {
          ...
          var parallaxSliderOptions = {
            speed: 1500,
            autoplay: {
              delay: 22500, //#############  durasi halaman slide
   ...
   $(function(){
    ...
    //#############  home button animation
     $('.home-link').on('click',function(){
      gsap.to('.city3-project',.5,{scale:.9});
      gsap.to('.city3-project',0,{width:'100%',height:'100vh',overflow:'hidden'});
      gsap.to('.city3-project',0,{display:'none',delay:.7});
      gsap.to('.city2-project',.5,{scale:.9});
      gsap.to('.city2-project',0,{width:'100%',height:'100vh',overflow:'hidden'});
      gsap.to('.city2-project',0,{display:'none',delay:.7});
    ...
    $('.city2-project-link').on('click',function(){
      gsap.to('#home',.5,{scale:.9});
      gsap.to('#home',0,{width:'100%',height:'100vh',overflow:'hidden'});
      gsap.to('#home',0,{display:'none',delay:.7});
      gsap.to('.city2-project',0,{display:'block',delay:.7})
      gsap.to('.city2-project',.5,{scale:1,delay:1.1})
      gsap.to('.project-name',.5,{opacity:0,delay:2.5})
      gsap.to('#breaker',{display:'block'})
      gsap.to('#breaker',0,{display:'none',delay:1.7});
    })
    $('.city3-project-link').on('click',function(){
      gsap.to('#home',.5,{scale:.9});
      gsap.to('#home',0,{width:'100%',height:'100vh',overflow:'hidden'});
      gsap.to('#home',0,{display:'none',delay:.7});
      gsap.to('.city3-project',0,{display:'block',delay:.7})
      gsap.to('.city3-project',.5,{scale:1,delay:1.1})
      gsap.to('.project-name',.5,{opacity:0,delay:2.5})
      gsap.to('#breaker',{display:'block'})
      gsap.to('#breaker',0,{display:'none',delay:1.7});
    })
